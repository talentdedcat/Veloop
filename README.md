<div align="center">
  ...
  <p>
    ...
    <img alt="release v0.2.2" src="https://img.shields.io/badge/release-v0.2.2-1683c7?style=flat">
...
[Download `Veloop-0.2.2-universal.dmg`](https://github.com/talentdedcat/Veloop/releases/download/v0.2.2/Veloop-0.2.2-universal.dmg),
open it, and drag `Veloop.app` to Applications.

> [!IMPORTANT]
> v0.2.2 is ad-hoc signed and not notarized. Only remove quarantine from a copy
