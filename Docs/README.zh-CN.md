<div align="center">
  ...
  <p>
    ...
    <img alt="版本 v0.3.0" src="https://img.shields.io/badge/release-v0.3.0-1683c7?style=flat">
...
[下载 `Veloop-0.3.0-universal.dmg`](https://github.com/talentdedcat/Veloop/releases/download/v0.3.0/Veloop-0.3.0-universal.dmg)，
打开后将 `Veloop.app` 拖入“应用程序”。

> [!IMPORTANT]
> v0.3.0 使用 ad-hoc 签名，尚未经过 Apple 公证。请只对从本仓库安装的
> Veloop 解除隔离，然后启动：
>
> ```bash
