<div align="center">
  ...
  <p>
    ...
    <img alt="版本 v0.3.1" src="https://img.shields.io/badge/release-v0.3.1-1683c7?style=flat">
...
[下载 `Veloop-0.3.1-universal.dmg`](https://github.com/talentdedcat/Veloop/releases/download/v0.3.1/Veloop-0.3.1-universal.dmg)，
打开后将 `Veloop.app` 拖入“应用程序”。

> [!IMPORTANT]
> v0.3.1 使用 ad-hoc 签名，尚未经过 Apple 公证。请只对从本仓库安装的
> Veloop 解除隔离，然后启动：
>
> ```bash
...
Veloop 启动后会检查 GitHub Release，每 24 小时最多自动检查一次。“软件更新”区域
也可以随时手动检查。发现新版本时，Veloop 会按当前应用语言显示改动，并可选择
“跳过此版本”、“稍后提醒”（24 小时后）或“前往下载”。Veloop 不会自动下载或安装更新。

更新检查只请求公开的 `update.json` Release 资产，不会发送剪贴板内容、历史记录、
设置、权限状态、设备标识或分析数据。
